	...
	<div class="w-2/3 p-5 text-white">
		...
		<div class="w-full text-lg">
			<span class="bg-white rounded-md p-3 font-medium mt-10 text-black items-center inline-flex"
				>Your badges <Icon icon="ooui:next-ltr" /></span
			>
		</div>
		<div></div>
	</div>
...
<div class="pt-10 px-32">
	<div class="flex justify-between items-center">
		<span class="text-3xl font-medium">Courses</span>
		<a href="/home" class="text-xl">see all</a>
	</div>

	<div class="text-xl font-medium flex my-5">
		<div class="mr-10 border-b-2 border-black">Suggested Courses</div>
		<div class="mr-10">In-progress (0)</div>
		<div class="mr-10">Completed (0)</div>
	</div>
	...
	<div class="flex justify-between items-center my-10">
		<span class="text-3xl font-medium">Forums</span>
		<a href="/home" class="text-xl">see all</a>
	</div>
	<div class="flex flex-wrap my-10">
		{#each posts as p}
	...
	<div class="flex justify-between items-center my-10">
		<span class="text-3xl font-medium">Daily Streak</span>
		<a href="/home" class="text-xl">see all</a>
	</div>
	...
	<div class="flex justify-between items-center my-10">
		<span class="text-3xl font-medium">Your skills</span>
		<a href="/home" class="text-xl">see all</a>
	</div>
