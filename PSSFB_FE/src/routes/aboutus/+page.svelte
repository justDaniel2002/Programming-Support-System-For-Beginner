...
<div class="bg-black text-white">
	...
	<p class="italic uppercase text-3xl font-bold ml-16 mr-52 tracking-wide whitespace-pre text-wrap">
		The technology project was carried out by a team of five people 

from FPT University
	</p>

	<div class="text-center text-4xl font-extrabold mt-20 mb-10">Teams</div>
	...
	<div class="flex items-center mt-20">
		...
		<div class="w-2/4 whitespace-pre font-medium text-wrap">
